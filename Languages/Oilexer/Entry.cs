...
{
    /// <summary>
    /// Provides a base implementation of <see cref="IEntry"/> which is
        ...
        IEntry
    {
        ...
        /// <summary>
        /// Creates a new <see cref="Entry"/> with the <paramref name="fileName"/>,
        /// <paramref name="column"/>, <paramref name="line"/>, and <paramref name="position"/>.
        /// </summary>
        /// <param name="fileName">The file in which the <see cref="Entry"/> was declared
        /// in.</param>
        /// <param name="column">The column at the current <paramref name="line"/> the 
        /// <see cref="Entry"/> was declared at. </param>
        /// <param name="line">The line index the <see cref="Entry"/> was declared at.</param>
        /// <param name="position">The position in the file the <see cref="Entry"/> 
        /// was declared at.</param>
        protected Entry(string fileName, int column, int line, long position)
        {
            this.column = column;
            this.line = line;
