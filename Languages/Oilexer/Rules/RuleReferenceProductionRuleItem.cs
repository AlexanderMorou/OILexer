...
namespace AllenCopeland.Abstraction.Slf.Languages.Oilexer.Rules
{
    ...
    /// is a <see cref="IProductionRuleItem"/> that references an <see cref="IProductionRuleEntry"/>.
    /// </summary>
        ...
        IRuleReferenceProductionRuleItem
    {
        ...
        /// </summary>
        private IProductionRuleEntry reference;
        /// <summary>
        ...
        /// </summary>
        /// <param name="reference">The <see cref="IProductionRuleEntry"/> which the 
        ...
        public RuleReferenceProductionRuleItem(IProductionRuleEntry reference, int column, int line, long position)
        ...
        /// </summary>
        public IProductionRuleEntry Reference
        {
