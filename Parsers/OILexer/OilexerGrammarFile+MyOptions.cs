...
{
    partial class OilexerGrammarFile
    {
        /// <summary>
        /// Private implementation of <see cref="IOilexerGrammarFileOptions"/>.
        /// </summary>
        private class MyOptions :
            IOilexerGrammarFileOptions
        {
            ...
            #region IOilexerGrammarFileOptions Members
            ...
            public string ParserName
            {
                get
                {
                    return this.parserName ?? (this.parserName = ParserResources.DefaultParserName);
                }
                set
                {
            ...
            public string LexerName
            {
                get
                {
                    return this.lexerName ?? (this.lexerName = ParserResources.DefaultLexerName);
                }
                set
                {
            ...
            public string GrammarName
            {
                get
                {
                    return this.grammarName ?? (this.grammarName = ParserResources.DefaultGrammarName);
                }
                set
                {
            ...
            public string AssemblyName
            {
                get
                {
                    return this.assemblyName ?? (this.assemblyName = ParserResources.DefaultAssemblyName);
                }
                set
                {
