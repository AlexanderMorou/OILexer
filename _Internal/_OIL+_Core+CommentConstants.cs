...
namespace Oilexer._Internal
{
    partial class _OIL
    {
        partial class _Core
        {
            internal class _CommentConstants
            {
                ...
                internal const string TypeParamTag = "<typeparam name=\"{0}\">{1}</typeparam>";
                internal const string TypeParamRefTag = "<typeparamref name=\"{0}\"/>";
            }
        }
    }
}
